        ...
        <div className={`relative w-full flex-1 flex items-center justify-center ${
          ...
          {projects.map((project, idx) => (
            ...
            >
              <AnimatePresence mode="wait">
                {activeIndex === idx && (
                  <motion.h3
                    ...
                    className="block text-center text-[clamp(1.5rem,4vw,3rem)] text-white/95 sm:absolute sm:-top-16 sm:left-[35%] lg:left-[-5%] sm:mb-0 italic font-semibold"
                    style={{
                      zIndex: 5,
                      textAlign: "left",
                    }}
              ...
              <div
                className="relative w-full overflow-hidden bg-black/20 shadow-2xl md:shadow-[0_35px_60px_-15px_rgba(0,0,0,0.7)] mb-10 sm:mb-12 rounded-xl h-[62vh] sm:h-[66vh]"
                style={{
                  zIndex: 10,
              ...
              >
                ...
                <div
                  ...
                  style={{
                    zIndex: 11,
                    background: "linear-gradient(rgba(0,0,0,0.12) 0%, rgba(0,0,0,0) 40%)"
                  }}
                />
              </div>

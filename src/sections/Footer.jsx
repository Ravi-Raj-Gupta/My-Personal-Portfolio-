...
const glowVariants = {
   ...
   hover: {
      ...
      y: -3,
      filter:
         "drop-shadow(0 8px 18px rgba(13,88,204,0.9)) drop-shadow(0 18px 18px rgba(16,185,129,0.8))",
...
export default function Footer() {
   return (
      <footer className="relative overflow-hidden bg-black">
         ...
         <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(55%_50%_at_30%_70%,rgba(16,185,129,0.30),transparent_70%)]" />
         <motion.div

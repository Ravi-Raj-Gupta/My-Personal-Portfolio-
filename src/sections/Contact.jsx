...
const SERVICE_ID = import.meta.env.VITE_SERVICE_ID || "service_afogtx3";
const TEMPLATE_ID = import.meta.env.VITE_TEMPLATE_ID || "template_say8log";
const PUBLIC_KEY = import.meta.env.VITE_PUBLIC_KEY || "sqtox8xkFWszZHymt";

export default function Contact() {
   useEffect(() => {
      if (!PUBLIC_KEY) {
         console.error("PUBLIC_KEY is not defined. Check your .env file");
         return;
      }
   ...
   const validateForm = () => {
      ...
      if (
         (formData.service === "Web Development" ||
            formData.service === "Mobile Application") &&
            ...
            >
               ...
               <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                  ...
                  <motion.button
                     ...
                     className="w-full bg-blue-600 text-white font-semibold py-3 rounded-md hover:bg-blue-700 transition disabled:bg-gray-500 mt-2"
